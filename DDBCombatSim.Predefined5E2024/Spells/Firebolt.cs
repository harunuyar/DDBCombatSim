...
{
    public Firebolt(CombatContext combatContext, ICombatant owner, EAbility spellcastingAbility) 
        : base(combatContext, "Firebolt", owner, new Cost() { Type = ECostType.Action, Amount = 1 }, false)
    {
